...
const Body = () => {
    return (
        <div className="">
            <div className="w-full flex flex-col xl:flex-row justify-around items-center gap-10 p-6">
                <div className="w-full xl:w-[40%] text-white">
                ...
                <div className="flex justify-center w-full xl:w-[40%]"><img src={image1} alt="team image" /></div>
            </div>
            <div className="w-full flex flex-col-reverse xl:flex-row justify-around items-center gap-10 p-6">
                <div className="w-full flex justify-center xl:w-[40%]"><img src={image2} alt="team image" /></div>
                <div className="w-full xl:w-[40%] text-white">
            ...
            <div className="w-full flex flex-col xl:flex-row justify-around items-center gap-10 p-6">
                ...
                <div className="w-full flex justify-center xl:w-[40%]"><img src={image3} alt="team image" /></div>
            </div>
        </div>
    )
}
