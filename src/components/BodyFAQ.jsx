    ...
    return (
        <div className="">
            <div className="flex flex-col items-center gap-10 p-6">
                <div className="text-white font-bold text-4xl lg:text-5xl border-b-2 border-stone-700">Help Center / FAQ</div>
                <div className="text-white text-lg lg:text-xl">Have questions? We’re here to help. Below are some of the most common questions about how Rentory works. If you need more support, feel free to contact us</div>
            </div>
            <div className="flex flex-col items-center gap-10 p-6">
                <div className="text-white font-bold text-2xl lg:text-3xl border-b-2 border-stone-700">1. How does Rentory work?</div>
                <div className="text-white text-lg lg:text-xl space-y-2">
                ...
                <div className="text-white text-lg lg:text-xl mx-5">
            ...
            <div className="flex flex-col items-center gap-10 p-6">
                <div className="text-white font-bold text-2xl lg:text-3xl border-b-2 border-stone-700">2. What are the rental terms?</div>
                <div className="text-white text-lg lg:text-xl">Rental terms may vary slightly depending on the item and the owner, but generally include:</div>
                <div className="text-white text-lg lg:text-xl mx-5">
            ...
            <div className="flex flex-col items-center gap-10 p-6">
                <div className="text-white font-bold text-2xl lg:text-3xl border-b-2 border-stone-700">3. What happens in case of damage?</div>
                <div className="text-white text-lg lg:text-xl">If an item is damaged during the rental period:</div>
                <div className="text-white text-lg lg:text-xl">
                    <ul className="flex flex-col w-[80%] lg:w-[40%] mx-auto list-disc space-y-2">
            ...
            <div className="flex flex-col items-center gap-10 p-6">
                <div className="text-white font-bold text-2xl lg:text-3xl border-b-2 border-stone-700">4. How are payments handled?</div>
                <div className="text-white text-lg lg:text-xl">All payments are processed securely through our platform.</div>
                <div className="text-white text-lg lg:text-xl mx-5">
                    <ul className="flex flex-col mx-auto list-disc space-y-2">
                ...
                <div className="text-white text-lg lg:text-xl">Receipts and transaction history can be found in your account dashboard.</div>
            </div>
        </div>
    )
}
